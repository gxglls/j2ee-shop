...
<%@page import="com.taoduoduo.order.OrderMrg"%>
...
<div id='module316' _indexClass='formIndex2' style="display:none" class='form form316 formIndex2 formStyle82 fk_bannerStyle0' title='' style='position:absolute;top:19px;left:903px;' _side='0' _inTab='0' _inMulMCol='0' _inFullmeasure='0' _autoHeight='1' _global='true' _independent='false' >
...
<table foldId='50' class='g_foldContainerValue g_foldContainerValue2 g_item fold_J fold_h_J' cellpadding='0' cellspacing='0'><tr><td class='g_foldContainerValueLeft'></td><td class='g_foldContainerValueCenter ' style='*padding:0;'><a hidefocus='true' href='pr.jsp?_pp=0_315_50_0&type=milk' title='影音娱乐' >饼干</a>
</td><td class='g_foldContainerValueRight'></td></tr></table>
</div>
...
<table foldId='51' class='g_foldContainerValue g_foldContainerValue2 g_item fold_J fold_h_J' cellpadding='0' cellspacing='0'><tr><td class='g_foldContainerValueLeft'></td><td class='g_foldContainerValueCenter ' style='*padding:0;'><a hidefocus='true' href='pr.jsp?_pp=0_315_51_1&type=milk' title='零食' >手机配件</a>
</td><td class='g_foldContainerValueRight'></td></tr></table>
...
<div class='richContent richContent0'><p><a href="index.jsp"_i="AGQIahIA" _n="发现美食" style="text-decoration:underline;font-weight:normal;"><img src="http://10233811.s21i-10.faiusr.com/4/ABUIABAEGAAg5L6aswUor9SdNjCyBzitAw.png" style="width:946px;height:429px;" alt=" " /></a></p></div></div>
</td>
...
<%
	...
	String[] imgs={"http://10233811.s21i-10.faiusr.com/4/ABUIABAEGAAg4p6eswUo_KjcnAEw0AE44AE.png","http://10233811.s21i-10.faiusr.com/4/ABUIABAEGAAgwJ6eswUo4OKGkwYw0AE44AE.png","http://10233811.s21i-10.faiusr.com/4/ABUIABAEGAAgwJ6eswUo4OKGkwYw0AE44AE.png"};
	String[] names={"新疆特产零食坚果大核桃仁非纸皮","新疆阿克苏产红枣干果零食小灰枣","薄皮核桃纸皮核桃奶油味坚果零食"};
	Double[] prices={20.0,20.0,20.0};
	
	if(usertype.equals("customer")){
		int categoryid=om.getMostCategoryidByCustomerIdFromOrderItem(customer.getId());
		if(categoryid>0){  //判断是否买过东西
			ArrayList<Product> plist=ProductMrg.get_instance().getProductsByCategoryId(categoryid);
			Iterator<Product> pit=plist.iterator();
			for(int k=0;k<3;k++){
				Product p= pit.next();
				imgs[k]="../images/product/"+p.getImage();
				names[k]=p.getName();
				prices[k]=p.getPrice();
			}
		}
...
<img src='<%=imgs[0] %>'  style='width:208px;height:224px;' alt='新疆特产零食坚果大核桃仁非纸皮' title=''/>
</a></td>
</tr>
</table>
</div>
<div class='propDiv productName productName_C  second_ProductName    ' style=''><a hidefocus='true' title='新疆特产零食坚果大核桃仁非纸皮' href='pd.jsp?id=6&_pp=2_338' target='_self'><%=names[0] %></a></div>
...
<img src='<%=imgs[1] %>'  style='width:208px;height:224px;' alt='新疆阿克苏产红枣干果零食小灰枣' title=''/>
</a></td>
</tr>
</table>
</div>
<div class='propDiv productName productName_C  second_ProductName    ' style=''><a hidefocus='true' title='新疆阿克苏产红枣干果零食小灰枣' href='pd.jsp?id=8&_pp=2_338' target='_self'><%=names[1] %></a></div>
<div style='padding:0;' class='propDiv dotted'></div>
...
<td style='overflow:hidden;' valign='middle' align='center'>
					<a hidefocus='true' href='pd.jsp?id=8&_pp=2_338' target='_self'>
<img src='<%=imgs[2] %>'  style='width:208px;height:224px;' alt='新疆阿克苏产红枣干果零食小灰枣' title=''/>
</a></td>
</tr>
</table>
</div>
<div class='propDiv productName productName_C  second_ProductName    ' style=''><a hidefocus='true' title='新疆阿克苏产红枣干果零食小灰枣' href='pd.jsp?id=8&_pp=2_338' target='_self'><%=names[2] %></a></div>
<div style='padding:0;' class='propDiv dotted'></div>
<div class='second_Pricepanel g_stress propDiv' style='padding:0;'>￥<span class='second_Price'>41<span style='font-size:12px;'>.90</span></span><span class='second_Marketprice'>￥42.90</span></div>
<div style='text-align:center;padding:0;' class='mallPanel propDiv'>
<a hidefocus='true' class='second_mallBuy   fk-mallBuy' href='pd.jsp?id=8&_pp=2_338' target='_self'>
...
<div class='formMiddleContent formMiddleContent339  ' tabStyle='0' style="display:none">
<div class='productMarqueeForms' newMarqueeToward=0><div class='demo'>
