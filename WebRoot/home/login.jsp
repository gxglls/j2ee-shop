...
<link rel='canonical' href='http://www.x552320945.icoc.me/login.jsp'>
...
#module28 {height:294px;}
#module28 .formBanner28{height:40px;}
#module28 .formBanner28{line-height:40px;}
#module28 .formBanner28 td{height:40px;}
#module28 .formBanner28 td{line-height:40px;}
#module28 .formBanner28 table{height:40px;}
#module28 .formBanner28 table{line-height:40px;}
#module28 .formBanner28 div{height:40px;}
#module28 .formBanner28 div{line-height:40px;}
...
#module28 .formBanner28{background:none;}
#module28 .formBanner28 .center28{background:none;}
#module28 .formBanner28 .right28{background:none;}
#module28 .formBanner28 .formBannerTitle28{background:none;}
#module28 .formBanner28 .titleCenter28{background:none;}
#module28 .formBanner28 .titleRight28{background:none;}
#module28 .formBanner28 .titleText28{background:none;}
#module28 .formBanner28 .left28{width:0px;height:0px;background:none;}
#module28 .formBanner28 .center28 .titleLeft28{width:0px;height:0px;background:none;}
...
<li><table cellpadding='0' cellspacing='0' width='100%'><tr><td align='center' valign='middle'><div class='sitetipsTitle'>在线商城为 <a class='sitetipsIcon siteGroupPop' target='_blank' hidefocus='true' href='http://jz.faisco.com/proFunc.jsp' title='点击查看详细功能列表'>网站推广版</a> 功能，8天后（2016-07-17 16:53）商城功能将自动失效。</div></td></tr></table></li></ul>
	...
	<div id="g_main" class='g_main g_col18 g_mainManage' style='top:31px' >
...
<div id='module28' _indexClass='formIndex2' class='form form28 formIndex2 formStyle53 fk_bannerStyle0' title='' style='' _side='0' _inTab='0' _inMulMCol='0' _inFullmeasure='0' _autoHeight='0' _global='false' _independent='false' >
...
<div class='titleText titleText28'><span class='fk_mainTitle mainTitle28'>会员登录</span></div>
</td>
...
<table class='formMiddle formMiddle28' style='height:294px; ' cellpadding='0' cellspacing='0'><tr>
...
<div id='memberLoginPwd' class='J_memberLoginItem memberLoginItem itemSpace'>
<input id='memberPwd' class='generateInput memberPwdInput' type='password' placeholder='密码' onkeydown='if (Fai.isEnterKey(	event)){Site.memberLogin2(28, 2,{"skipUrl":"index.jsp","isPhotoGroup":false});}' />
</div>
<div class='J_memberLoginItem memberCaptcha memberLoginItem'>
<input id='memberLoginCaptcha' class='memberCaptchaInput' type='text' placeholder='验证码' />
<img alt='' id='memberCaptchaImg' class='memberCaptchaImg' onclick='Site.changeCaptchaImg(this)' title='看不清，换一张'/>
</div>
<div class='memberLoginItem memberLoginItem_Button'>
<div class=' J_loginButton loginButton loginButton11'>
<div class='left'></div>
...
<div class='signup'>
<a class='regAcct' hidefocus='true' href='javascript:;' onclick='Site.memberSignup("");return false;' >免费注册></a>
</div>
</div>
</div>
</td>
...
function showYuanDanWindow(){
	...
	fk_sale.popupWindowMs = -808759764;
...
$(function() {
	...
	// ajax统计
	Site.total({colId:18, pdId:-1, ndId:-1, sc:0, rf:"http://www.x552320945.icoc.me"});
	//前端性能数据上报
	Site.report();
