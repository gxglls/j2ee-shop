...
<link rel='canonical' href='http://www.x552320945.icoc.me/signup.jsp'>
...
<link type='text/css' href=http://2.ss.faisys.com/css/signup.min.css?v=201605312145 rel='stylesheet' />
...
#module27 {height:503px;}
#module27 .formBanner27{height:40px;}
#module27 .formBanner27{line-height:40px;}
#module27 .formBanner27 td{height:40px;}
#module27 .formBanner27 td{line-height:40px;}
#module27 .formBanner27 table{height:40px;}
#module27 .formBanner27 table{line-height:40px;}
#module27 .formBanner27 div{height:40px;}
#module27 .formBanner27 div{line-height:40px;}
#module27 .titleText27 .mainTitle27{font-size:15px;}
#module27 .titleText27 .mainTitle27{font-weight:normal;}
#module27 .titleCenter27{overflow:visible;}
#module27 .titleText27 span{left:0px;}
#module27 .titleText27 span{top:0px;}
#module27 .titleText27 .mainTitle27{font-family:微软雅黑;}
#module27 .formBanner27{background:none;}
#module27 .formBanner27 .center27{background:none;}
#module27 .formBanner27 .right27{background:none;}
#module27 .formBanner27 .formBannerTitle27{background:none;}
#module27 .formBanner27 .titleCenter27{background:none;}
#module27 .formBanner27 .titleRight27{background:none;}
#module27 .formBanner27 .titleText27{background:none;}
#module27 .formBanner27 .left27{width:0px;height:0px;background:none;}
#module27 .formBanner27 .center27 .titleLeft27{width:0px;height:0px;background:none;}
...
<li><table cellpadding='0' cellspacing='0' width='100%'><tr><td align='center' valign='middle'><div class='sitetipsTitle'>在线商城为 <a class='sitetipsIcon siteGroupPop' target='_blank' hidefocus='true' href='http://jz.faisco.com/proFunc.jsp' title='点击查看详细功能列表'>网站推广版</a> 功能，8天后（2016-07-17 16:53）商城功能将自动失效。</div></td></tr></table></li></ul>
	...
	<div id="g_main" class='g_main g_col17 g_mainManage' style='top:31px' >
...
<div id='module27' _indexClass='formIndex2' class='form form27 formIndex2 formStyle52 fk_bannerStyle0' title='' style='' _side='0' _inTab='0' _inMulMCol='0' _inFullmeasure='0' _autoHeight='0' _global='false' _independent='false' >
<table class='formTop formTop27' cellpadding='0' cellspacing='0'><tr><td class='left'></td><td class='center'></td><td class='right'></td></tr></table>
<table class='formBanner formBanner27' cellpadding='0' cellspacing='0'><tr>
<td class='left left27'></td>
<td class='center center27' valign='top'>
<table cellpadding='0' cellspacing='0' class='formBannerTitle formBannerTitle27'><tr>
<td class='titleLeft titleLeft27' valign='top'>
</td>
<td class='titleCenter titleCenter27' valign='top'>
<div class='titleText titleText27'><span class='fk_mainTitle mainTitle27'>会员注册</span></div>
</td>
...
<table class='formMiddle formMiddle27' style='height:503px; ' cellpadding='0' cellspacing='0'><tr>
<td class='formMiddleLeft formMiddleLeft27'></td>
<td class='formMiddleCenter formMiddleCenter27' valign='top'>
<div class='formMiddleContent formMiddleContent27  ' tabStyle='0'>
...
<div class='memberSignupItem itemSpace'>
<div class='itemLeft'>密码：</div>
<div class='itemMiddle'>
<input type='password' id='memberSignupPwd' maxlength='50' />
</div>
<div class='itemRight'>*</div>
</div>
<div class='memberSignupItem itemSpace'>
<div class='itemLeft'>确认密码：</div>
<div class='itemMiddle'>
<input type='password' id='memberSignupRepwd' maxlength='50' />
</div>
<div class='itemRight'>*</div>
</div>
<div class='memberSignupItem itemSpace'>
...
<div class='memberSignupItem itemSpace'>
<div class='itemLeft' title='电话'>电话：</div>
<div class='itemMiddle'>
<input id='phone' name='电话' placeholder= '' class='userAddItem' type='text' maxlength='50'  />
</div>
<div class='itemRight'></div>
</div>
<div class='memberSignupItem_remark itemSpace'>
<div class='itemLeft'>留言：</div>
<div class='itemMiddle'>
...
<div class='itemMiddle'>
<input id='memberSignupCaptcha' type='text' maxlength='4' onKeyDown='if(event.keyCode==13){Site.memberSignupSubmit(27, "/index.jsp", 2)};' />
</div>
<div class='itemRight'><img alt='' id='memberSignupCaptchaImg' class='memberSignupCaptchaImg' onclick='Site.changeCaptchaImg(this)' title='看不清，换一张' src='validateCode.jsp?365'/></div>
</div>
<div id='memberSignupButton' class='memberSignupItem_signupButton memberSignupItem_signupButton11'>
...
function showYuanDanWindow(){
	...
	fk_sale.popupWindowMs = -808759818;
...
$(function() {
	...
	// ajax统计
	Site.total({colId:17, pdId:-1, ndId:-1, sc:0, rf:"http://www.x552320945.icoc.me"});
	//前端性能数据上报
	Site.report();
...
Site.initModuleMemberSignup(27, 2,false, "/index.jsp");
