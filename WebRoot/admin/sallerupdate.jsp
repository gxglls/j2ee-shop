...
<%@ page language="java" import="java.util.*,com.taoduoduo.admin.*" pageEncoding="UTF-8"%>
...
<%
	...
	if(temp!=null&&!temp.equals("")){
		shop_id=Integer.parseInt(temp);
		s=SallerMrg.get_instance().getSallerById(shop_id);
	}
    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" action="sallerupdatedeal.jsp" method="post">
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">用户名</label>
              <div class="am-u-sm-9">
                <input type="text" name="username" id="username" value="<%=s.getName() %>">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="password" id="password" value=<%=s.getPassword() %>>
                <small></small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <textarea class="" rows="5" id="descr" name="descr" ><%=s.getDescr() %></textarea>
              </div>
            </div>
