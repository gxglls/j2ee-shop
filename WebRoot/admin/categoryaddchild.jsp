    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" action="categoryaddchilddeal.jsp" method="post">
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">类被名称</label>
              <div class="am-u-sm-9">
                <input type="text" name="name" id="username">
                <input type="hidden" name="pid" id="username" value="<%= request.getParameter("pid") %>">
              </div>
            </div>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="admin.jsp?id=4"  type="button" class="am-btn am-btn-primary">放弃</a>
              </div>
            </div>
          </form>
        </div>
