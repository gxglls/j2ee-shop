...
<%@ page language="java" import="java.util.*,com.taoduoduo.product.*" pageEncoding="UTF-8"%>
    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" name="uploadForm" method="POST" enctype="MULTIPART/FORM-DATA" action="../FileUp">
            <div class="am-form-group">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="price" id="password">
                <small></small>
              </div>
            </div>
            
             <div class="am-form-group">
              <label for="user-email" class="am-u-sm-3 am-form-label">选择类别</label>
              <div class="am-u-sm-9">
                <select name="category">
                	<%
                		ArrayList<Category> clist=new ArrayList<Category>();
                		CategoryMrg.get_instance().getCategories(clist, -1);
                		Iterator<Category> it=clist.iterator();
                		String realname="";
                		while(it.hasNext()){
                			Category c=it.next();
/*                 			String pre="";
             ...
             <div class="am-form-group">
              <label for="user-email" class="am-u-sm-3 am-form-label">生产时间</label>
              <div class="am-u-sm-9">
                <input type="text" name="time" id="password">
                <small></small>
              </div>
            </div>
            
            <div class="am-form-group">
              <label for="user-email" class="am-u-sm-3 am-form-label">库存</label>
              <div class="am-u-sm-9">
                <input type="text" name="stock" id="password">
                <small></small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <textarea class="" rows="5" id="descr" name="descr" ></textarea>
              </div>
            </div>
