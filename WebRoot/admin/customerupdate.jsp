...
<%
	...
	if(temp!=null&&!temp.equals("")){
		...
		s=CustomerMrg.get_instance().getCustomerById(id);
	}
          ...
          <form class="am-form am-form-horizontal" action="customerupdatedeal.jsp" method="post">
            ...
            <div class="am-form-group">
             ...
             <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="telephone" id="password" value=<%=s.getTelephone() %>>
                <small></small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              <label for="user-email" class="am-u-sm-3 am-form-label">电话</label>
              <div class="am-u-sm-9">
                <input type="text" name="email" id="password" value=<%=s.getEmail() %>>
                <small></small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <textarea class="" rows="5" id="descr" name="address" ><%=s.getAddress() %></textarea>
              </div>
            </div>
